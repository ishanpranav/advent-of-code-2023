...
| 20  |        [Pulse Propagation](src/day20b.c)        |   Graph theory, Number theory, Dictionaries, Circuit design    |        Product        |  0.01  | [Euclidean algorithm](https://en.wikipedia.org/wiki/Euclidean_algorithm), map-based graph, length-prefixed string                                                          |
